...
class screen(Widget):
    ...
    def update_display(self):
        ...
        rn = datetime.datetime.now(tz=pytz.timezone('America/Los_Angeles'))
...
class pdtmonApp(App):
    def build(self):
        rtn = screen()
        rtn.update_display()
        Clock.schedule_interval(lambda dt: rtn.update_display(), 60*10)  # update every 10 min. randomly chosen
        return rtn
